...
render_views
	...
	describe "GET 'index'" do
		...
		describe "for signed in users" do
			...
			it "should have delete links for admins (only)" do
				@user.toggle!(:admin)
			...
			it "should not have delete links for non-admins (only)" do
				other_user = User.all.second
				get 'index'
...
describe "POST 'create'" do
	...
	describe "failure" do
		...
		before(:each) do
		@attr = {   :name=> "", :email => "", :phone=>"", :skype=>"", :time_zone=>"", 
				:rate=>"", :notes =>"", :password=>"", :password_confirmation=>""}
		end
...
describe "PUT 'update'" do
	...
	describe 'authentification for user edit and update actions' do
		...
		describe "as an admin user" do
			...
			before(:each) do
				@user = Factory(:user, :email => "myadmin@example.com", :admin => true)
				test_sign_in(@user)
			end
